...
if __name__=="__main__":
    ...
    # Example usage:
    relative_file_path = "train_res/YCB/checkpoints/YCB_11-22_02:32_FC_FT_Rand_placing_Goal_10_maxstable50_Weight_rewardPobj100.0/YCB_11-22_02:32_FC_FT_Rand_placing_Goal_10_maxstable50_Weight_rewardPobj100.0_155000"
    local_project_path = "/home/grl/Working/projects/RoboSensai"
    server_project_path = "/home/yj208/Working/RoboSensai"
    local_abs_file_path = os.path.join(local_project_path, relative_file_path)
    server_abs_folder_path = os.path.join(server_project_path, os.path.dirname(relative_file_path))
