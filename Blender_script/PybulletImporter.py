...
evalUniName_lst = ["Union_03-12_23:40Sync_Beta_table_PCExtractor_Rand_ObjPlace_Goal_maxObjNum10_maxPool10_maxScene1_maxStab60_contStab20_Epis2Replaceinf_Weight_rewardPobj100.0_seq5_step80_trial5_entropy0.01_seed123456_EVAL_best_Scene_table_32_objRange_10_10"]
render_nums = 1
animation = False
set_blender_engine(render_engine='CYCLES') # 'BLENDER_EEVEE', 'CYCLES'
QrSceneCenter2Camera = [1.7, 0., 1.8]
...
for evalUniName in evalUniName_lst:
    ...
    for i, filepath in enumerate(blender_filepaths):
        ...
        _, max_frame = load_pkl(filepath, load_all=animation)
        ...
        if "table" in json_data["specific_scene"]:
            ...
            focus_point=(0, 0, qr_scene_halfexts[2])
