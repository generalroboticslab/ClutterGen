...
arrowBox_asset_file = "objects/ycb_objects_origin_at_center_vhacd/urdfs/cube_arrow.urdf"
arrow_box_asset = gym.load_asset(sim, asset_root, arrowBox_asset_file, asset_options)
...
for i in range(num_envs):
    ...
    arrowBox_pose = deepcopy(box_pose)
    arrowBox_pose.p.z += 0.6 * box_size
    arrowBox_pose.r = gymapi.Quat.from_axis_angle(gymapi.Vec3(0, 0, 1), np.random.uniform(-math.pi, math.pi))

    arrowBox_handle = gym.create_actor(env, arrow_box_asset, arrowBox_pose, "arrowBox", i, 0)
